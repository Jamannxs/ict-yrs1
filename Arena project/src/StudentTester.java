...
public class StudentTester {
	...
	public static void bonusCredit()
	{
		...
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Samurai, Arena.Row.Front, 2);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Cherry, Arena.Row.Front, 3);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Healer, Arena.Row.Front, 4);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Tank, Arena.Row.Front, 5);
		
		//Add players to the Back row of Team A
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Tank, Arena.Row.Back, 1);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Cherry, Arena.Row.Back, 2);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Samurai, Arena.Row.Back, 3);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.BlackMage, Arena.Row.Back, 4);
