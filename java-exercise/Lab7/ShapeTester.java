...
public class ShapeTester {
	   public static void main(String[] args) {
	      ...
	      Pentagon s6 = new Pentagon();
	      s6.setColor("white");
	      System.out.println("--These are challenge mode--");
	      System.out.println("Area is " + s6.getArea(5.0, 10.0));
	      System.out.println(s6);  // Run Pentagon's toString()
	      
	      Shape s7 = new Pentagon("burgundy red", 5, 10);
	      System.out.println("___/ :') \\___\n"+s7);  // Run Pentagon's toString()
